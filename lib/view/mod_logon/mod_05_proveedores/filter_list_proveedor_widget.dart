...
class FilterListCargoWidget extends StatefulWidget {
  ...
  FilterListCargoWidget({
    super.key,
    required this.selectedItem,
  });

  @override
  FilterListCargoWidgetState createState() => FilterListCargoWidgetState();
}

class FilterListCargoWidgetState extends State<FilterListCargoWidget> {
  final TextEditingController _nombreController = TextEditingController();
  final GlobalKey<SearchListWidgetState<Cargo>> _searchListWidgetKey = GlobalKey<SearchListWidgetState<Cargo>>();
  ...
  @override
  void didUpdateWidget(covariant FilterListCargoWidget oldWidget) {
  ...
  Widget build(BuildContext context) {
    return SearchListWidget<Cargo>(
      ...
      fetchData: (DateTime offset, int take, bool forceRefresh, Future<void> Function() reset) async {
        ResultOf<List<Cargo>> result = await serv.fetchDataFind(
            offset,
            take,
