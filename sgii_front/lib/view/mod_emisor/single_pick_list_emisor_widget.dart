...
class SinglePickListEmisorWidget extends StatefulWidget {
  final Emisor? Function() getItem;
  final void Function(Emisor? item) setItem;
  ...
  @override
  SinglePickListEmisorWidgetState createState() =>SinglePickListEmisorWidgetState();
}

class SinglePickListEmisorWidgetState extends State<SinglePickListEmisorWidget> {
              ...
              return ItemEmisorWidget(
                ...
                selectedItem: (BuildContext itemEmisorWidgetContext, ItemList<DbObj> item, void Function() fSetState) async {
                  ...
                  if (item.selected){
                    ...
                    widget.setItem(item.value as Emisor);
                  }else{
