...
class MultiPickListEmisorEstablecimientoWidget extends StatefulWidget {
  List<ItemList<DbObj>>? Function() getLItem;
  void Function(List<ItemList<DbObj>>? item) setLItem;
  MultiPickListEmisorEstablecimientoWidget({
    super.key,
  ...
  @override
  MultiPickListEmisorEstablecimientoWidgetState createState() => MultiPickListEmisorEstablecimientoWidgetState();
}

class MultiPickListEmisorEstablecimientoWidgetState extends State<MultiPickListEmisorEstablecimientoWidget> {
  ...
  Widget build(BuildContext context) {
    return PickListWidget(
      ...
      hintText: 'Seleccione EmisorEstablecimiento',
