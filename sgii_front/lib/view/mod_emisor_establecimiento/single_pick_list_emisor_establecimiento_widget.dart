...
class SinglePickListEmisorEstablecimientoWidget extends StatefulWidget {
  final EmisorEstablecimiento? Function() getItem;
  final void Function(EmisorEstablecimiento? item) setItem;
  ...
  @override
  SinglePickListEmisorEstablecimientoWidgetState createState() =>SinglePickListEmisorEstablecimientoWidgetState();
}

class SinglePickListEmisorEstablecimientoWidgetState extends State<SinglePickListEmisorEstablecimientoWidget> {
  final TextEditingController _nombreController = TextEditingController();
  final TextEditingController _itemController = TextEditingController();
  final GlobalKey<SearchListWidgetState<EmisorEstablecimiento>> _searchListEmisorEstablecimientoWidgetKey = GlobalKey<SearchListWidgetState<EmisorEstablecimiento>>();
  EmisorEstablecimiento itemSelect = EmisorEstablecimiento.empty();
    ...
    return PickWidget(
        ...
        filterList: (BuildContext context, Future<void> Function() onSetState) {
          return SearchListWidget<EmisorEstablecimiento>(
            key: _searchListEmisorEstablecimientoWidgetKey,
            itemCard: (BuildContext context, ItemList<DbObj> item_) {
              ItemList<DbObj> encontrado = lItemPickList.firstWhere(
                ...
                orElse: () => ItemList<DbObj>( value: EmisorEstablecimiento.empty()),
              );
              if (encontrado.value.estado != EmisorEstablecimiento.empty().estado){
              ...
              return ItemEmisorEstablecimientoWidget(
                item: item_,
                listWidgetKey: null,
                searchListWidgetKey: _searchListEmisorEstablecimientoWidgetKey,
                selectedItem: (BuildContext itemEmisorEstablecimientoWidgetContext, ItemList<DbObj> item, void Function() fSetState) async {
                  ...
                  if (item.selected){
                    ...
                    widget.setItem(item.value as EmisorEstablecimiento);
                  }else{
                    lItemPickList.remove(item);
                  }
                  fSetState();
                  _searchListEmisorEstablecimientoWidgetKey.currentState?.resetGuardaPosLista();
                },
              );
            },
            fetchData: (DateTime offset, int take, bool forceRefresh, Future<void> Function() reset) async {
              ResultOf<List<EmisorEstablecimiento>> result = await servEmisorEstablecimiento.fetchDataFind(
                  offset,
                  take,
        ...
        selectedItemCard: (BuildContext pickListWidget,  ItemList<DbObj> item_){
          EmisorEstablecimiento value = item_.value as EmisorEstablecimiento;
          return Card(
            elevation: 4,
            color: Colors.grey,
