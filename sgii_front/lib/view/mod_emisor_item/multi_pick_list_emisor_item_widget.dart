...
class MultiPickListEmisorItemWidget extends StatefulWidget {
  List<ItemList<DbObj>>? Function() getLItem;
  void Function(List<ItemList<DbObj>>? item) setLItem;
  MultiPickListEmisorItemWidget({
    super.key,
  ...
  @override
  MultiPickListEmisorItemWidgetState createState() => MultiPickListEmisorItemWidgetState();
}

class MultiPickListEmisorItemWidgetState extends State<MultiPickListEmisorItemWidget> {
  ...
  Widget build(BuildContext context) {
    return PickListWidget(
      ...
      hintText: 'Seleccione EmisorItem',
