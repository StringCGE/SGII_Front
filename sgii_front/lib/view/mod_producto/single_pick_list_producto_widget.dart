...
class SinglePickListProductoWidget extends StatefulWidget {
  final Producto? Function() getItem;
  final void Function(Producto? item) setItem;
  ...
  @override
  SinglePickListProductoWidgetState createState() =>SinglePickListProductoWidgetState();
}

class SinglePickListProductoWidgetState extends State<SinglePickListProductoWidget> {
