...
class FilterListProveedorWidget extends StatefulWidget {
  ...
  FilterListProveedorWidget({
    super.key,
    required this.selectedItem,
  });

  @override
  FilterListProveedorWidgetState createState() => FilterListProveedorWidgetState();
}

class FilterListProveedorWidgetState extends State<FilterListProveedorWidget> {
  final TextEditingController _nombreController = TextEditingController();
  final GlobalKey<SearchListWidgetState<Proveedor>> _searchListWidgetKey = GlobalKey<SearchListWidgetState<Proveedor>>();
  ProveedorService serv = ProveedorService();
  ...
  @override
  void didUpdateWidget(covariant FilterListProveedorWidget oldWidget) {
  ...
  Widget build(BuildContext context) {
    return SearchListWidget<Proveedor>(
      ...
      fetchData: (DateTime offset, int take, bool forceRefresh, Future<void> Function() reset) async {
        ResultOf<List<Proveedor>> result = await serv.fetchDataFind(
            offset,
            take,
