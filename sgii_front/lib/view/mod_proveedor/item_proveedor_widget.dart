...
class ItemProveedorWidget extends StatefulWidget {
  final ItemList<DbObj> item;
  final GlobalKey<SearchListWidgetState<Proveedor>>? searchListWidgetKey;
  final GlobalKey<ListWidgetState<Proveedor>>? listWidgetKey;
  ...
  ItemProveedorWidgetState createState() => ItemProveedorWidgetState();
}
class ItemProveedorWidgetState extends State<ItemProveedorWidget>{
  ProveedorService serv = ProveedorService();

  @override
  Widget build(BuildContext context) {
    Proveedor value = widget.item.value as Proveedor;
    widget.item.reset = (){
      if (mounted) {
        setState(() {});
      }
