...
class MultiPickListTipoIdentificacionWidget extends StatefulWidget {
  List<ItemList<DbObj>>? Function() getLItem;
  void Function(List<ItemList<DbObj>>? item) setLItem;
  MultiPickListTipoIdentificacionWidget({
    super.key,
  ...
  @override
  MultiPickListTipoIdentificacionWidgetState createState() => MultiPickListTipoIdentificacionWidgetState();
}

class MultiPickListTipoIdentificacionWidgetState extends State<MultiPickListTipoIdentificacionWidget> {
  ...
  Widget build(BuildContext context) {
    return PickListWidget(
      ...
      hintText: 'Seleccione TipoIdentificacion',
